...
augroup vimrc-python
  ...
  autocmd FileType python nnoremap <buffer> <F10> :w <cr> :exec '!clear; python3' shellescape(@%, 1) <cr>
  autocmd FileType python nnoremap <buffer> <F9> :w <cr> :exec '!clear; python3' shellescape(@%, 1) 0 10 -1 <cr>
augroup END
